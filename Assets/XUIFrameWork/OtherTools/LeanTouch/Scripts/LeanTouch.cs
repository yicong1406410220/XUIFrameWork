		...
		public static void MoveObject(Transform transform, Vector2 deltaPosition, Camera camera = null)
		{
			if (transform != null)
			{
				if (deltaPosition.x != 0.0f || deltaPosition.y != 0.0f)
				{
                    ...
                    deltaPosition = new Vector2(0, deltaPosition.y / 30);
                    // If this is RectTransform then modify the anchoredPosition
                    if (rectTransform != null)
                    {

                        if (rectTransform.anchoredPosition.y + deltaPosition.y <= -2)
                        {
                            rectTransform.anchoredPosition = new Vector2(rectTransform.anchoredPosition.x, -2);
                        }

                        else if (rectTransform.anchoredPosition.y + deltaPosition.y >= 73)
                        {
                            rectTransform.anchoredPosition = new Vector2(rectTransform.anchoredPosition.x, 73);
                        }
                        else
                        {
